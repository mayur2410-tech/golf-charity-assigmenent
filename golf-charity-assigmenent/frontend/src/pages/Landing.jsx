...
export default function Landing() {
  ...
  return (
    <div className="page-bg" style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* ── HERO ── */}
      <section style={{ position: 'relative', padding: '140px 24px 80px', textAlign: 'center', zIndex: 10 }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: 99, color: '#60a5fa', fontSize: '0.8rem', fontWeight: 600, letterSpacing: '0.05em', marginBottom: 32 }}>
      ...
      {/* ── BENTO BOX SHOWCASE ── */}
      <section style={{ padding: '0 24px 120px', position: 'relative', zIndex: 20 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true, margin: "-100px" }} className="bento-grid">
            ...
            <motion.div variants={fadeUp} className="bento-card bento-col-8" style={{ padding: 0, display: 'flex', flexDirection: 'column', position: 'relative' }}>
              ...
              {/* Graphic container */}
              <div style={{ position: 'relative', flex: 1, minHeight: 240, overflow: 'hidden', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                ...
                {/* Number balls */}
                <div style={{ display: 'flex', gap: 16, position: 'relative', zIndex: 10, paddingBottom: 40 }}>
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" style={{ padding: '100px 24px', maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 20 }}>
      ...
      {/* ── PRIZES ── */}
      <section id="prizes" style={{ padding: '100px 24px', background: 'rgba(255,255,255,0.01)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', position: 'relative', zIndex: 20 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <motion.div variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: 64 }}>
      ...
      {/* ── CHARITIES ── */}
      <section id="charities" style={{ padding: '120px 24px', maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 20 }}>
        <div className="bento-grid" style={{ alignItems: 'center' }}>
          <motion.div variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} className="bento-col-5" style={{ paddingRight: 40 }}>
      ...
      {/* ── PRICING ── */}
      <section id="pricing" style={{ padding: '100px 24px', background: 'rgba(255,255,255,0.01)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', position: 'relative', zIndex: 20 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
           <motion.div variants={fadeUp} initial="initial" whileInView="animate" viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="bento-grid">
             ...
             <motion.div variants={fadeUp} className="bento-card bento-col-4" style={{ padding: 48, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginTop: 'auto' }}>
                   <GlowButton variant="ghost" style={{ width: '100%' }} onClick={() => navigate('/register')}>Subscribe Monthly</GlowButton>
                </div>
             </motion.div>
             ...
             <motion.div variants={fadeUp} className="bento-card bento-col-4" style={{ padding: 48, display: 'flex', flexDirection: 'column', background: 'linear-gradient(145deg, rgba(59,130,246,0.1) 0%, rgba(255,255,255,0.01) 100%)', borderColor: 'rgba(59,130,246,0.3)' }}>
                <div style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', background: '#3b82f6', color: 'white', padding: '4px 16px', borderBottomLeftRadius: 8, borderBottomRightRadius: 8, fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Most Popular</div>
                ...
                <div style={{ marginTop: 'auto' }}>
                   <GlowButton style={{ width: '100%' }} onClick={() => navigate('/register')}>Subscribe Yearly</GlowButton>
                </div>
             </motion.div>
             ...
             <motion.div variants={fadeUp} className="bento-card bento-col-4" style={{ padding: 48, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginTop: 'auto' }}>
                   <GlowButton variant="ghost" style={{ width: '100%' }} onClick={() => navigate('/register')}>Get Pro Plus</GlowButton>
                </div>
             </motion.div>
          </motion.div>
        </div>
      ...
      {/* Footer */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '40px 24px', textAlign: 'center', background: '#020617' }}>
